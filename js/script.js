...
(function () {
  ...
  function erow(label,val){ if(val==null||String(val)==="") return ""; return '<tr><td style="padding:10px 0;border-bottom:1px solid #e0edf2;font-size:12px;color:#5a7382;vertical-align:top;white-space:nowrap">'+esc(label)+'</td><td style="padding:10px 0 10px 18px;border-bottom:1px solid #e0edf2;font-size:14px;color:#0f1e26;font-weight:600;vertical-align:top;text-align:right">'+esc(val)+'</td></tr>'; }
  function erowMail(label,val){ if(val==null||String(val)==="") return ""; return '<tr><td style="padding:10px 0;border-bottom:1px solid #e0edf2;font-size:12px;color:#5a7382;vertical-align:top;white-space:nowrap">'+esc(label)+'</td><td style="padding:10px 0 10px 18px;border-bottom:1px solid #e0edf2;font-size:14px;vertical-align:top;text-align:right"><a href="mailto:'+esc(val)+'" style="color:#0b7f8f;font-weight:700;text-decoration:none">'+esc(val)+'</a></td></tr>'; }
  function erowPhone(label,val){ if(val==null||String(val)==="") return ""; var tel=String(val).replace(/[^\d+]/g,""); return '<tr><td style="padding:10px 0;border-bottom:1px solid #e0edf2;font-size:12px;color:#5a7382;vertical-align:top;white-space:nowrap">'+esc(label)+'</td><td style="padding:8px 0 8px 18px;border-bottom:1px solid #e0edf2;vertical-align:middle;text-align:right"><a href="tel:'+esc(tel)+'" style="display:inline-block;background:#e9f2f6;color:#0b7f8f;font-weight:700;font-size:13.5px;padding:7px 14px;border-radius:999px;text-decoration:none;white-space:nowrap">&#128222; '+esc(val)+'</a></td></tr>'; }
